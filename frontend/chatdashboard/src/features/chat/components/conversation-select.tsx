...
export function ConversationSelect({
  ...
  return (
    <div className='border-border/50 bg-background/80 flex flex-col gap-3 rounded-2xl border p-3 backdrop-blur-xl sm:gap-4 sm:rounded-3xl sm:p-4 lg:hidden shadow-xs'>
      <div className='flex items-center justify-between gap-2 sm:gap-3'>
        ...
        <Badge
          variant='outline'
          className='bg-primary/10 text-primary border-primary/20 rounded-full px-2 py-0.5 text-[0.65rem] uppercase tracking-wider'
        >
          Live
        </Badge>
      </div>
      <div className='space-y-1.5 sm:space-y-2'>
        ...
        <select
          ...
          className='border-border/50 bg-muted/40 text-foreground focus:border-primary/40 focus:ring-primary/30 w-full rounded-xl border px-2.5 py-1.5 text-xs focus:ring-2 focus:outline-none sm:rounded-2xl sm:px-3 sm:py-2 sm:text-sm'
        >
